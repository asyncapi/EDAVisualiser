...
export const Menu = () => {
  return <div className="absolute top-0 left-0 bg-white grid grid-cols-1 gap-4" style={{zIndex: 10000}}>
    <div className="space-x-2 py-2 m-4 inline-block text-lg px-2 text-gray-800">
      <span className="font-bold">Visualiser</span>
    </div>
    <div style={{padding: "0 30px"}}><a href="/social-media/" className="font-light capitalize">View system</a></div>
