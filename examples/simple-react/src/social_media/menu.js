...
export const Menu = <div className="absolute top-0 left-0 bg-white grid grid-cols-1 gap-4" style={{zIndex: 10000}}>
  <div className="space-x-2 py-2 m-4 border border-gray-100 inline-block text-lg px-2 text-gray-800">
    <span className="font-bold">Event Visualiser</span>
    <span className="text-gray-200">|</span>
    <span className="font-light capitalize">System view</span>
  </div>
